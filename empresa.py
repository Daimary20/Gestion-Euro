...
# --- 1. CONFIGURACIÓN ---
# URL y Clave verificadas para evitar el error 401 de tus capturas
...
# Código de seguridad para nuevos registros
...
# Se define fuera de funciones con caché para evitar el 'CachedWidgetWarning'
